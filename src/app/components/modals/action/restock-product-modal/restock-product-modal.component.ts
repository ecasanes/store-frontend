...
@Component({
    selector: 'app-restock-product-modal',
    templateUrl: './restock-product-modal.component.html',
    styleUrls: ['./restock-product-modal.component.css']
})
export class RestockProductModalComponent implements OnInit {
