...
@Component({
    selector: 'app-deliver-single-item-modal',
    templateUrl: './deliver-single-item-modal.component.html',
    styleUrls: ['./deliver-single-item-modal.component.css']
})
export class DeliverSingleItemModalComponent implements OnInit {
    ...
    onDeliver() {
        ...
        this.deliverSingleItem(newDelivery);

    }

    deliverSingleItem(delivery: NewDelivery) {

        this.updating = true;

        this.deliveryService.addConfirmedDelivery(delivery)
            .subscribe(
                (response) => {
