...
@Component({
    selector: 'app-all-seller-products',
    templateUrl: './all-seller-products.component.html',
    styleUrls: ['./all-seller-products.component.css']
})
export class AllSellerProductsComponent implements OnInit {
